...
-- Leadership does NOT want multiple separate analyses. They want one final dataset that can directly feed into Power BI / Excel dashboard for decision-making. This dataset should summarize route performance with all key KPIs + risk tag.
...
SELECT route_id, origin_hub, destination_hub, total_shipments, utilization_pct, delay_pct, sla_breach_pct,
    CASE 
        WHEN delay_pct > 30 
